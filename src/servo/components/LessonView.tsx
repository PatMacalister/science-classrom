...
import type { Lesson } from "@/servo/lib/curriculum/types";
import { getLesson, getUnit, lessonNumber, lessonsOfUnit, prevNext } from "@/servo/lib/curriculum/registry";
import { annotateFormulas } from "@/servo/lib/curriculum/glossary";
import { isFullyTranslated, localizeLesson, localizeUnit } from "@/servo/lib/curriculum/localize";
  ...
  return (
    <article>
      ...
      {lesson.buildsOn?.length ? (
        <p className="builds-on">
          ...
          {lesson.buildsOn.map((slug) => {
            ...
            return l ? (
              <Link key={slug} href={`/servo/lesson/${slug}`}>
      ...
      <nav className="lesson-nav">
        {prev ? (
          <Link className="nav-card" href={`/servo/lesson/${prev.slug}`}>
