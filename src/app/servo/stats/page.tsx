...
import { LESSONS, UNITS, lessonsOfUnit } from "@/servo/lib/curriculum/registry";
import { localizeUnit } from "@/servo/lib/curriculum/localize";
...
/** Review-map keys from the parts-bench drill rather than lesson quizzes. */
const DRILL_PREFIXES = ["pb:"];
  ...
  return (
    <div>
      ...
      <section className="stats-section">
        ...
        {due.length > 0 ? (
          <p>
            <Link className="btn secondary" href="/servo/review">
              {t("reviewDeck")}
            </Link>
          </p>
        ) : null}
