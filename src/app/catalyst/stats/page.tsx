...
import { LESSONS, UNITS, lessonsOfUnit } from "@/catalyst/lib/curriculum/registry";
import { localizeUnit } from "@/catalyst/lib/curriculum/localize";
...
/** Review-map keys from the element drill rather than lesson quizzes. */
const DRILL_PREFIXES = ["el:"];
  ...
  return (
    <div>
      ...
      <section className="stats-section">
        ...
        {due.length > 0 ? (
          <p>
            <Link className="btn secondary" href="/catalyst/review">
              {t("reviewDeck")}
            </Link>
          </p>
        ) : null}
