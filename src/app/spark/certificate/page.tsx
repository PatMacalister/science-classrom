...
import { LESSONS, getLesson } from "@/spark/lib/curriculum/registry";
...
const CAPSTONES = ["capstone", "pwm-dimmer", "night-light", "oscilloscope"];
    ...
    <div>
      ...
      <div className="cert-frame">
        ...
        <div className="cert-builds">
          ...
          <span>{t("certBuild3")}</span>
          <span>{t("certBuild4")}</span>
        </div>
        <p>{t("certEvery")}</p>
