...
import { LESSONS, UNITS, lessonsOfUnit } from "@/spark/lib/curriculum/registry";
import { localizeUnit } from "@/spark/lib/curriculum/localize";
...
/** Spark has no reference drill (yet) — every review card is a quiz question. */
const DRILL_PREFIXES: string[] = [];
  ...
  return (
    <div>
      ...
      <section className="stats-section">
        ...
        {due.length > 0 ? (
          <p>
            <Link className="btn secondary" href="/spark/review">
              {t("reviewDeck")}
            </Link>
          </p>
        ) : null}
