...
import { LESSONS, UNITS, lessonsOfUnit } from "@/helix/lib/curriculum/registry";
import { localizeUnit } from "@/helix/lib/curriculum/localize";
...
/** Review-map keys from the codon drill rather than lesson quizzes. */
const DRILL_PREFIXES = ["aa:", "cd:"];
  ...
  return (
    <div>
      ...
      <section className="stats-section">
        ...
        {due.length > 0 ? (
          <p>
            <Link className="btn secondary" href="/helix/review">
              {t("reviewDeck")}
            </Link>
          </p>
        ) : null}
