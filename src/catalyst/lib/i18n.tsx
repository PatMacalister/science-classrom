...
const EN = {
  ...
  elementsDrillView: "Drill",
  elementsNoHit: "Nothing matches “{q}”.",
  drillTricky: "Tricky symbols",
  drillCommon: "First 36",
  drillAll: "All 118",
  drillPoolSize: "{n} in this set",
  drillWhichElement: "Which element is this?",
  drillWhichSymbol: "What is the symbol for {name}?",
  drillRight: "✓ Correct.",
  drillWrong: "✗ Not quite — it is {answer}.",
  drillNext: "Next card →",
  drillStart: "Start the drill →",
  drillStartBody: "Pick a set above, then start. Symbols and names, both directions, four options a card.",
  drillFoot:
...
const DE: Record<keyof typeof EN, string> = {
  ...
  elementsDrillView: "Üben",
  elementsNoHit: "Nichts passt zu „{q}“.",
  drillTricky: "Knifflige Symbole",
  drillCommon: "Erste 36",
  drillAll: "Alle 118",
  drillPoolSize: "{n} in dieser Auswahl",
  drillWhichElement: "Welches Element ist das?",
  ...
  drillStartBody: "Wähle oben eine Auswahl und leg los. Symbole und Namen, in beide Richtungen, vier Optionen pro Karte.",
  drillFoot:
