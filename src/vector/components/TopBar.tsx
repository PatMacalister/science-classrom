...
import { LESSONS } from "@/vector/lib/curriculum/registry";
import { useProgress } from "@/shared/progress";
import { useLang, useT, type Lang } from "@/vector/lib/i18n";
  ...
  return (
    <header className="topbar">
      <div className="topbar-left">
        ...
        <Link className="brand" href="/vector">
          🪐 Vector Academy
        </Link>
      </div>
      <div className="topbar-right">
        ...
        <Link className="topbar-link" href="/vector/units">
          {t("siLink")}
        </Link>
