...
import type { Lesson } from "@/helix/lib/curriculum/types";
import { getLesson, getUnit, lessonNumber, lessonsOfUnit, prevNext } from "@/helix/lib/curriculum/registry";
import { annotateFormulas } from "@/helix/lib/curriculum/glossary";
import { isFullyTranslated, localizeLesson, localizeUnit } from "@/helix/lib/curriculum/localize";
  ...
  return (
    <article>
      ...
      {lesson.buildsOn?.length ? (
        <p className="builds-on">
          ...
          {lesson.buildsOn.map((slug) => {
            ...
            return l ? (
              <Link key={slug} href={`/helix/lesson/${slug}`}>
      ...
      <nav className="lesson-nav">
        {prev ? (
          <Link className="nav-card" href={`/helix/lesson/${prev.slug}`}>
