...
const EN = {
  ...
  tierAdvancedTag: "Heredity, evolution and ecology, then the body's own systems — immunity, nerves — and finally the tools that edit the code itself.",
...
const DE: Record<keyof typeof EN, string> = {
  ...
  tierAdvancedTag: "Vererbung, Evolution und Ökologie, dann die Systeme des Körpers — Immunabwehr, Nerven — und zuletzt die Werkzeuge, die den Code selbst umschreiben.",
